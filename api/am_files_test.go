...
func TestGetAmFiles(t *testing.T) {
	const policypath = "https://repo.adeo.no/repositories/raw/nais/testapp/2" +
		".0/am/app-policies.xml"
	const notenforcedpath = "https://repo.adeo.no/repositories/raw/nais/testapp/2" +
...
func TestFetchNonExistingFilesShouldReturnError(t *testing.T) {
	...
	assert.Equal(t, "https://repo.adeo.no/repositories/raw/nais/testapp/2"+
